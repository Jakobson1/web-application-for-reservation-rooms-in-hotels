  ...
  <strong><%= msg %></strong>
    ...
    <%
        try{
                ...
                ResultSet rezultat = stmt.executeQuery("SELECT * FROM sobe");
                while(rezultat.next()){%>
                    
                
            <tr>
                <td></td>
                <td><%= rezultat.getString("SobeID")%></td>
                <td><%= rezultat.getString("ime")%></td>
                <td><%= rezultat.getString("tip")%></td>
                <td><%= rezultat.getString("cenaNoc")%></td>
                
                

                <td class="text-center"><form action="izmenaSoba.jsp" method="post">
                         <input type="hidden" name="SobeID" value="<%=rezultat.getString("SobeID")%>">
                        <button class='btn btn-info btn-xs' href="#"><span class="glyphicon glyphicon-edit"></span> Izmeni</button>
                    </form></td>
                    <td>
                        <form action="ObrisiSobe" method="post" >
                            <input type="hidden" name="SobeID" value="<%=rezultat.getString("SobeID")%>">
...
<a class="btn btn-success" href="DodajSobu.jsp">Dodaj novo</a>
