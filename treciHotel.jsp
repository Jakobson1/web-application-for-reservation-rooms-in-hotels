  ...
  <!-- Facebook and Twitter integration -->
    ...
    <body>
        ...
        try{
                ...
                ResultSet rezultat = stmt.executeQuery("SELECT * FROM sobe WHERE ime='Soba sa pogledom'");
                while(rezultat.next()){%>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 room-wrap animate-box">
                                            <a href="css/images/sobe/slika7.jpg" class="room image-popup-link"><img width="360" height="300" src="<%=rezultat.getString("slika") %>"/>
</a>
						<div class="desc text-center">
							...
							<ul>
								...
								<li><i class="icon-check"></i>Soba sa pogledom na more</li>
								<li><i class="icon-check"></i>Wellnes centar besplatno</li>
							</ul>
						</div>
					</div>
        ...
        try{
                ...
                ResultSet rezultat = stmt.executeQuery("SELECT * FROM sobe WHERE ime='Soba proleca '");
                while(rezultat.next()){%>
                
                
                		<div class="col-md-4 room-wrap animate-box">
                                    <a href="css/images/sobe/slika8.jpg" class="room image-popup-link"><img width="360" height="300" src="<%=rezultat.getString("slika") %>"/></a>
						...
						<div class="desc text-center">
							...
							<ul>
								<li><i class="icon-check"></i><%=rezultat.getString("tip")%></li>
                                                                <li><i class="icon-check"></i>Soba koja mirise na prolece</li>
								<li><i class="icon-check"></i>Klima uredjaj besplatan</li>
							</ul>
						</div>
					</div>
        ...
        try{
                ...
                ResultSet rezultat = stmt.executeQuery("SELECT * FROM sobe WHERE ime='Soba leta'");
                while(rezultat.next()){%>
                
                
                		<div class="col-md-4 room-wrap animate-box">
                                 <a href="css/images/sobe/slika9.jpg" class="room image-popup-link"><img width="360" height="300" src="<%=rezultat.getString("slika") %>"/></a>
						...
						<div class="desc text-center">
							...
							<ul>
								<li><i class="icon-check"></i><%=rezultat.getString("tip")%></li>
								<li><i class="icon-check"></i>Proglasena za sobu leta ove godine</li>
								<li><i class="icon-check"></i>Besplatna masaza</li>
							</ul>
						</div>
					</div>
